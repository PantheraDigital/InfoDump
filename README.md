...
![Screenshot of old version of this webpage.](project-imgs/PantheraDigital_PageScreenshot.webp)
...
![Icon for Godot Engine (a blue robot head), with an antenna.](project-imgs/PantheraDigital_ModularCharacterController.webp)
...
![Screenshot of the landing page for a generic trip booking website.](project-imgs/PantheraDigital_FullstackClientMainPage.webp)
...
![Diagram of cloud website services. Client connects to AWS, which connects to S3, which connects to API Gateway, which connects to Lambda, which connects to Dynamo DB.](project-imgs/PantheraDigital_AWSStack.webp)
...
![Screenshot of the github page for the Character Step project.](project-imgs/PantheraDigital_GodotCharacterStep.webp)
...
![Screenshot of the character sheet webpage, showing a form like layout with many text and number boxes.](project-imgs/PantheraDigital_CharaterStatSheet.webp)
...
![Screenshot of Fab marketplace showing the listing for the Melee Hit Trace pack.](project-imgs/PantheraDigital_MeleeHitTrace.webp)
...
![Screenshot of a video game character jumping between different green platforms.](project-imgs/PantheraDigital_EntityController.webp)
...
![ComboHeader](post-imgs/ComboHeader.webp)
